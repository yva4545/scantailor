...
BOOST_AUTO_TEST_CASE(test_same_file)
{
	...
	QString const somefile("/etc/somefile");
...
{
	SmartFilenameOrdering const less;
	QString const lhs("1.png");
	QString const rhs("2.png");
...
{
	SmartFilenameOrdering const less;
	QString const lhs("a_0002.png");
	QString const rhs("a_1.png");
...
{
	SmartFilenameOrdering const less;
	QString const lhs("a10_10.png");
	QString const rhs("a010_2.png");
	BOOST_CHECK(less(lhs, rhs) == false);
	BOOST_CHECK(less(rhs, lhs) == true);
}
...
{
	SmartFilenameOrdering const less;
	QString const lhs("10.png");
	QString const rhs("010.png");
	BOOST_CHECK(less(lhs, rhs) == false);
	BOOST_CHECK(less(rhs, lhs) == true);
}
